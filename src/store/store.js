...
const actions = {
  ...
  login: (context, user) => {
    ...
    axios.post('https://localhost:4000/api/auth/login', user).then(response => {
  ...
  getUserState: (context, payload) => {
    ...
    axios.get(`https://localhost:4000/api/user/${payload}`).then(response => {
  ...
  getAllUsers: (context, payload) =>{
      axios.get('https://localhost:4000/api/users/all').then(response=>{
  ...
  follow: (context, payload) => {
    axios.post('https://localhost:4000/api/user/follow', payload).then(response => {
  ...
  unfollow: (context, payload) => {
    axios.post('https://localhost:4000/api/user/unfollow', payload).then(response => {
