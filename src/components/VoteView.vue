...
<script>
  ...
  export default {
    ...
    methods: {
     ...
     closeUserSession() {
      ...
      vote(option) {
        ...
        this.axios.put(`/api/poll/${this.selectedPollData.pollID}`, voteObject).then(response => {
      ...
      guestVote(option) {
        ...
        this.axios.put(`/api/poll/guest/${this.selectedPollData.pollID}`, voteObject).then(
          response => {
    ...
    created() {
      ...
      this.axios.get(`/api/poll/${this.$route.params.pollId}`).then(response => {
